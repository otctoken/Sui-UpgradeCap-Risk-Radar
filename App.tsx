...
import { Radar, Search, Filter, ChevronLeft, ChevronRight, Check, ChevronDown, BookOpen, LayoutDashboard, ExternalLink, PlusCircle, Send, Menu, X } from 'lucide-react';
      ...
      <header className="bg-slate-900 border-b border-slate-800 sticky top-0 z-40">
        <div className="max-w-4xl mx-auto px-4">
          <div className="flex items-center justify-between py-4">
            ...
            {/* Logo Area */}
            <div className="flex items-center gap-3 cursor-pointer" onClick={() => { setCurrentView('dashboard'); setIsMobileMenuOpen(false); }}>
              <div className="bg-sui-blue p-2 rounded-lg shadow-lg shadow-sui-blue/20">
                  <Radar className="w-6 h-6 text-white" />
              </div>
              <h1 className="text-lg md:text-xl font-bold tracking-tight text-white">Sui UpgradeCap Radar</h1>
            </div>
